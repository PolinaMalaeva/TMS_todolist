...
function List(props: { errorInput: React.RefObject<HTMLDivElement>; }): JSX.Element {
    ...
    const handleOnChange = (e: (React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLTextAreaElement>), id: number) => {
        let arr: IList[] = Object.assign([], list);
        ...
        if (e.target.className.includes('edit_title')) {
            ...
            if ((e.target as HTMLInputElement).value.match(/\d/)) {
                ...
                return (setTimeout(() => props.errorInput.current!.style.cssText = `opacity: 0; z-index:-1`, 5000))
            }
                    ...
                    <div className="task" key={task.id}>
                        ...
                        <div className="task_description">
                                <textarea className="task_edit edit_description"
                                          ...
                                          style={{
                                              ...
                                              outline: (/\S/.test(task.value.description.description)) ? '' : '2px solid red'
                                          }}
                                          onChange={(e) => handleOnChange(e, task.id)}
                        ...
                        <div className="control">
                            <div className="edit" onClick={(e) => {
                                ...
                                <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="80px"
                                     height="80px">
                                    <path
