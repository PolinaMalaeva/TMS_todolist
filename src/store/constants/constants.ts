...
export const TIME_FIRST_TASK = "Время создания первой задачи";
export const TIME_LAST_TASK = "Время создания последней задачи";

export const CREATE_LIST = "Создание списка";
export const UPDATE_LIST = "Обновление списка";
